...
const translations: Record<Language, Record<string, string>> = {
  vi: {
    ...
    'user_management_desc': 'Xem danh sách giáo viên, học viên, tạo tài khoản',
    'assignment_management': 'Quản lý Bài tập',
    'assignment_management_desc': 'Xem tất cả bài tập, trạng thái nộp',
    'role_management': 'Quản lý Phân quyền',
    'role_management_desc': 'Thiết lập vai trò cho người dùng: admin, teacher, student',
    'statistics_view': 'Xem Thống kê',
    'statistics_view_desc': 'Số lượng user, khóa học, bài nộp gần đây',
  ...
  en: {
    ...
    'vision_statement_quote': '"every individual has the potential to reach further if they are given the right knowledge, the right methods, and at the right time"',
    ...
    'mission_statement_quote': '"provide high-quality learning opportunities for everyone, regardless of age, profession, or place of residence"',
    ...
    'feature_community_desc': 'Forums for discussion, Q&A, and sharing experiences.',
    'development_journey_title': 'Development Journey',
    'development_journey_desc_part1': 'Starting from a group of education and technology enthusiasts, we have continuously strived to build a reputable learning platform.',
    'development_journey_desc_highlight': '10,000 students',
    'development_journey_desc_part2': 'nationwide and are expanding into the international market.',
    ...
    'user_management_desc': 'View list of teachers, students, create accounts',
    'assignment_management': 'Assignment Management',
    'assignment_management_desc': 'View all assignments, submission status',
    'role_management': 'Role Management',
    'role_management_desc': 'Set roles for users: admin, teacher, student',
    'statistics_view': 'View Statistics',
    'statistics_view_desc': 'Number of users, courses, recent submissions',
