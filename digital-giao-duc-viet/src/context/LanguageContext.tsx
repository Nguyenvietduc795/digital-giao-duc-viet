...
const translations: Record<Language, Record<string, string>> = {
  vi: {
    ...
    'world_changing_by_tech_education_right': 'Trong một thế giới đang chuyển mình mạnh mẽ bởi công nghệ, <strong className="text-pink-500">giáo dục không còn là đặc quyền, mà là quyền lợi của tất cả mọi người</strong>.',
  ...
  en: {
    ...
    'world_changing_by_tech_education_right': 'In a world rapidly transforming by technology, <strong className="text-pink-500">education is no longer a privilege, but a right for everyone</strong>.',
